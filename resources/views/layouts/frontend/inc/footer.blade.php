        ...
        <div class="row">
            <div class="newslatter">
                <form>
                    ...
                    <h4 class="title-subline">Its totally FREE !</h4>
                    <div class="input-group">
                        <input type="text" class=" form-control" placeholder="Your-email@flybuy.com">
...
<footer>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3 footer-block">
                ...
                05,Senpara Parbata<br>
                Mirpur 10, Dhaka City-1216 <br>
                Bangladesh</span></li>
                            <li><i class="fa fa-envelope"></i><span class="mail2"><a href="#">info@flybuy.com</a><br>
                <a href="#">your@flybuy.com</a></span></li>
                            <li><i class="fa fa-mobile"></i><span class="phone2">+880 1969474545<br>
                +880 1969474545</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="footer-bottom">
        <div id="bottom-footer">
            ...
            <div class="copyright"> Copyright - <a class="yourstore" href="http://www.lionode.com/"> Created by Kaisar Jamil &copy; 2020 </a></div>
